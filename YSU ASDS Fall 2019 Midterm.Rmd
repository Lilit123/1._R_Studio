...
MyData <- read.csv(file="C:\\Users\\ISTC\\Desktop\\New folder (2)\\surveydata.csv", header=TRUE, sep="," , na = c(99,100,98," ", NA))
...
```{r setup, include = FALSE} 
age <- 2019 - MyData$P2_Year
MyData <- data.frame(MyData,age)
head(MyData)
...
names(MyData) <- c("TT", "TreatmentType")
